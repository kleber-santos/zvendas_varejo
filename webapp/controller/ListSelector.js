sap.ui.define([
		...
		return BaseObject.extend("arcelor.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias arcelor.model.ListSelector
			 */
			 ...
			 * @return {arcelor.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
